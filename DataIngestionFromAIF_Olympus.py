...
ws = Workspace.get(name="eunmldevamlwsgom2",
                subscription_id='cf11c61d-e6ca-4f6b-b8df-d2a77e8a4d04',
                resource_group='SEQ00963-NPRD-EUN-MLDEV-AML-gom2')
...
stringtorun = "SELECT WORK_ORDER_NUMBER, EXECUTION_CONDITION_CODE , MAINTENANCE_PLANNER_GROUP FROM DM_WORK.FACT_WORK_NOTIFICATION WHERE MAINTENANCE_PLANNER_GROUP='OLY'"
query = DataPath(datastore,stringtorun)
tabular = Dataset.Tabular.from_sql_query(query, query_timeout=300)
