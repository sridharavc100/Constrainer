...
stringtorun = "SELECT WORK_ORDER_NUMBER, EXECUTION_CONDITION_CODE , MAINTENANCE_PLANNER_GROUP FROM DM_WORK.FACT_WORK_NOTIFICATION WHERE MAINTENANCE_PLANNER_GROUP='426'"
query = DataPath(datastore,stringtorun)
tabular = Dataset.Tabular.from_sql_query(query, query_timeout=300)
